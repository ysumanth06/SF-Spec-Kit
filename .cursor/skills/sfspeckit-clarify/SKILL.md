...
This skill performs a deep analysis of the feature specification to identify logic gaps, missing edge cases, and architectural risks. It generates a formal "Clarification Report" for Business and TPO sign-off, ensuring the foundation is solid before technical planning begins.
